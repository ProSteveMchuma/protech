...
const BID_STEPS: ProcessStep[] = [
    {
        ...
        illustration: <ProcessIllustration step={1} />,
    },
    {
        icon: ClipboardCheck,
        ...
        illustration: <ProcessIllustration step={2} />,
    },
    {
        icon: FileText,
        ...
        illustration: <ProcessIllustration step={3} />,
    },
    {
        icon: Send,
        ...
        illustration: <ProcessIllustration step={4} />,
    },
    {
        icon: LineChart,
        ...
        illustration: <ProcessIllustration step={5} />,
    },
];
