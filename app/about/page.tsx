        ...
        <div className="bg-press text-white">
            <section className="relative overflow-hidden border-b border-white/10 pb-24 pt-36 sm:pb-32 sm:pt-44">
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
                    <div className="max-w-4xl">
                        <p className="flex items-center gap-2 kicker text-cyan-300"><MapPin className="size-3.5" /> Nairobi, Kenya · Built for print production</p>
            ...
            <section className="bg-white py-24 text-slate-950 sm:py-32">
                <div className="mx-auto grid max-w-7xl gap-14 px-4 sm:px-6 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
                    <div><p className="kicker text-cyan-700">Why we build</p><h2 className="mt-4 text-4xl font-black tracking-[-.04em] sm:text-5xl">Production is skilled work. Repetition is not.</h2></div>
