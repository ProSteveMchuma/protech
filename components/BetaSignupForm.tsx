...
const fieldClass = "mt-2 w-full rounded-lg border border-white/15 bg-press px-4 py-3 text-sm text-white outline-none placeholder:text-slate-600 focus:border-cyan-300 focus:ring-2 focus:ring-cyan-300/15";
...
export function BetaSignupForm({ defaultNeed = "both" }: { defaultNeed?: Values["primaryNeed"] }) {
    ...
    return <form onSubmit={handleSubmit(submit)} className="rounded-2xl border border-white/10 bg-press-panel p-6 shadow-2xl sm:p-8" noValidate>
